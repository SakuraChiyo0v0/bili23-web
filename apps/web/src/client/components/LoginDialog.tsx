    ...
    <div className="overlay sheet-on-mobile center-mobile" onMouseDown={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="modal sm login-modal">
        ...
        <div className="login-tabs">
          <button className={`login-tab${tab === "qr" ? " active" : ""}`} onClick={() => setTab("qr")}>{tr("扫码登录")}</button>
          ...
          {tab === "qr" ? (
            ...
            <div className="cookie-pane">
              ...
              <div className="modal-foot">
                <div className="right">
                  <button type="button" className="btn primary" disabled={submitting} onClick={doCookie}>{submitting ? tr("校验中…") : tr("登录")}</button>
                </div>
              </div>
            </div>
          )}
